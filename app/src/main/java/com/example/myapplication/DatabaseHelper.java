        ...
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
                    ...
                    String imageUri = cursor.getString(cursor.getColumnIndex(TRANS_COL_IMAGE_URI)); // Retrieve imageUri
                    transactions.add(new Transaction(amount, category, transactionType, imageUri)); // Add imageUri to constructor
